...
<head>
    ...
    <link rel="shortcut icon" href="img/favicon.logotikom.white.ico">
    <title>Catatan Keuanganku - Dashboard</title>
...
<body>
    <div class="header">
        <img src="img/favicon.logotikom.black.ico" width="25px" height="25px" class="float-left logo-fav">
        <h3 class="text-secondary font-weight-bold float-left logo">Catatan</h3>
        <h3 class="text-secondary float-left logo2">Keuanganku</h3>
        <a href="logout">
            <div class="logout">
                <i class="fas fa-sign-out-alt float-right log"></i>
                <p class="float-right font-weight-bold logout">Logout</p>
            </div>
        </a>
    </div>
    ...
    <div class="sidebar">
        <nav>
            <ul>
                <li class="rentang">
                    <img src="img/soccer-player.png " class="img-fluid profile float-left" width="60px">
    ...
    <div class="main-content khusus">
        <div class="konten khusus2">
            <div class="konten_dalem khusus3">
                <h2 class="heade" style="color: #4b4f58;">Beranda</h2>
                <hr style="margin-top: -2px;">
                    <div class="container" id="container" style="border: none;">
                        <div class="row tampilCardview" id="row">
                            <div class="col-md-5 jarak">
                                <div class="card card-stats card-warning" style="background: #7F5C54;">
                                    <div class="card-body ">
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="icon-big text-center">
                                                <i class="fas fa-dollar-sign ikon"></i>
                                            </div>
                                        </div>
                                ...
                                <div class="card card-stats card-warning" style="background: #7F5C54;">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="icon-big text-center">
                                                <i class="fas fa-piggy-bank ikon"></i>
                                                </div>
                                            </div>
                                            <div class="col-7 d-flex align-items-center tulisan">
                                                <div class="numbers">
